      ...
      <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 flex flex-col relative">
        ...
        <div className="flex flex-col xl:flex-row justify-between xl:items-center mb-6 gap-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {isGoogleConnected && onDisconnectGoogle && (
              <button
                onClick={onDisconnectGoogle}
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm bg-green-50 border border-green-200 dark:border-green-600 hover:bg-green-100 dark:hover:bg-green-900/20 text-green-700 dark:text-green-400 transition-all"
              >
                <img src="https://www.google.com/favicon.ico" alt="Google" className="w-4 h-4" />
            ...
            <div className="relative">
              <button
                ...
                className={`p-2 border rounded-lg transition-colors ${showCalendarList
